...
- `settle_game`:
  - winner REAL → mahazo ny pot manontolo (ohatra 3P 1000 → 2700, tombony +1700). Ny système no mandoa ny anjaran'ny bot.
  - winner VIRTUAL → **very fotsiny** ny mise an'ny mpilalao tena izy: tsy misy wallet mahazo, tsy ampiana amin'ny `admin_wallets` mihitsy (commission 10% ihany no azon'ny admin).
